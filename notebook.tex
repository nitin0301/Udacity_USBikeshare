...
\textbf{Answer}: 1. As a Motivate's decision maker, i would like to know
if the bike system is working efficiently. One measure will be an
estimate of bikes that are not being used for a given route. An overall
picture will allow us to reallocating bikes to maximize utility and
increase income. 2. As a user, I would like to know the more frequent
paths taken by fellow riders to explore and find alternative routes.
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}17}]:} \PY{k}{def} \PY{n+nf}{print\PYZus{}first\PYZus{}point}\PY{p}{(}\PY{n}{filename}\PY{p}{)}\PY{p}{:}
         ...
         \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
             ...
             \PY{k}{with} \PY{n+nb}{open}\PY{p}{(}\PY{n}{filename}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{r}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)} \PY{k}{as} \PY{n}{f\PYZus{}in}\PY{p}{:}
                 ...
                 \PY{c+c1}{\PYZsh{}print(trip\PYZus{}reader)}
...
below to address each of the cleaning tasks described above.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}77}]:} \PY{k}{def} \PY{n+nf}{duration\PYZus{}in\PYZus{}mins}\PY{p}{(}\PY{n}{datum}\PY{p}{,} \PY{n}{city}\PY{p}{)}\PY{p}{:}
             \PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}}
         ...
         \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
             ...
             \PY{k}{if} \PY{n}{city} \PY{o}{==} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{NYC}\PY{l+s+s2}{\PYZdq{}}\PY{p}{:}
                 \PY{n}{dur} \PY{o}{=} \PY{n+nb}{list}\PY{p}{(}\PY{n}{datum}\PY{o}{.}\PY{n}{values}\PY{p}{(}\PY{p}{)}\PY{p}{)}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}
                 \PY{n}{duration} \PY{o}{=} \PY{n+nb}{float}\PY{p}{(}\PY{n}{dur}\PY{p}{)}\PY{o}{/}\PY{l+m+mf}{60.0}
                 \PY{c+c1}{\PYZsh{}print(city,dur,duration)}
             \PY{k}{elif} \PY{n}{city} \PY{o}{==} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Chicago}\PY{l+s+s2}{\PYZdq{}}\PY{p}{:}
                 \PY{n}{dur} \PY{o}{=} \PY{n+nb}{list}\PY{p}{(}\PY{n}{datum}\PY{o}{.}\PY{n}{values}\PY{p}{(}\PY{p}{)}\PY{p}{)}\PY{p}{[}\PY{l+m+mi}{4}\PY{p}{]}
                 \PY{n}{duration} \PY{o}{=} \PY{n+nb}{float}\PY{p}{(}\PY{n}{dur}\PY{p}{)}\PY{o}{/}\PY{l+m+mf}{60.0}
                 \PY{c+c1}{\PYZsh{}print(city,dur,duration)}
             \PY{k}{else}\PY{p}{:}
                 \PY{n}{dur} \PY{o}{=} \PY{n+nb}{list}\PY{p}{(}\PY{n}{datum}\PY{o}{.}\PY{n}{values}\PY{p}{(}\PY{p}{)}\PY{p}{)}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}
                 \PY{n}{duration} \PY{o}{=} \PY{n+nb}{float}\PY{p}{(}\PY{n}{dur}\PY{p}{)}\PY{o}{/}\PY{p}{(}\PY{l+m+mi}{1000}\PY{o}{*}\PY{l+m+mf}{60.0}\PY{p}{)}
                 \PY{c+c1}{\PYZsh{}print(city,dur,duration)}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}78}]:} \PY{k}{def} \PY{n+nf}{time\PYZus{}of\PYZus{}trip}\PY{p}{(}\PY{n}{datum}\PY{p}{,} \PY{n}{city}\PY{p}{)}\PY{p}{:}
             \PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}}
         \PY{l+s+sd}{    Takes as input a dictionary containing info about a single trip (datum) and}
         ...
         \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
             ...
             \PY{c+c1}{\PYZsh{} YOUR CODE HERE}
             \PY{k}{if} \PY{n}{city} \PY{o}{==} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{NYC}\PY{l+s+s2}{\PYZdq{}}\PY{p}{:}
                 \PY{n}{time\PYZus{}date} \PY{o}{=} \PY{n+nb}{list}\PY{p}{(}\PY{n}{datum}\PY{o}{.}\PY{n}{values}\PY{p}{(}\PY{p}{)}\PY{p}{)}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}
                 \PY{n}{temp} \PY{o}{=} \PY{n}{datetime}\PY{o}{.}\PY{n}{strptime}\PY{p}{(}\PY{n}{time\PYZus{}date}\PY{p}{,}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{\PYZpc{}}\PY{l+s+s2}{m/}\PY{l+s+si}{\PYZpc{}d}\PY{l+s+s2}{/}\PY{l+s+s2}{\PYZpc{}}\PY{l+s+s2}{Y }\PY{l+s+s2}{\PYZpc{}}\PY{l+s+s2}{H:}\PY{l+s+s2}{\PYZpc{}}\PY{l+s+s2}{M:}\PY{l+s+s2}{\PYZpc{}}\PY{l+s+s2}{S}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
                 \PY{n}{month} \PY{o}{=} \PY{n}{temp}\PY{o}{.}\PY{n}{month}
                 \PY{n}{hour} \PY{o}{=} \PY{n}{temp}\PY{o}{.}\PY{n}{hour}
                 \PY{n}{day\PYZus{}of\PYZus{}week} \PY{o}{=} \PY{n}{temp}\PY{o}{.}\PY{n}{strftime}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{A}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
             \PY{k}{else}\PY{p}{:}
                 \PY{n}{time\PYZus{}date} \PY{o}{=} \PY{n+nb}{list}\PY{p}{(}\PY{n}{datum}\PY{o}{.}\PY{n}{values}\PY{p}{(}\PY{p}{)}\PY{p}{)}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}
                 \PY{n}{temp} \PY{o}{=} \PY{n}{datetime}\PY{o}{.}\PY{n}{strptime}\PY{p}{(}\PY{n}{time\PYZus{}date}\PY{p}{,}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{\PYZpc{}}\PY{l+s+s2}{m/}\PY{l+s+si}{\PYZpc{}d}\PY{l+s+s2}{/}\PY{l+s+s2}{\PYZpc{}}\PY{l+s+s2}{Y }\PY{l+s+s2}{\PYZpc{}}\PY{l+s+s2}{H:}\PY{l+s+s2}{\PYZpc{}}\PY{l+s+s2}{M}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
                 \PY{n}{month} \PY{o}{=} \PY{n}{temp}\PY{o}{.}\PY{n}{month}
                 \PY{n}{hour} \PY{o}{=} \PY{n}{temp}\PY{o}{.}\PY{n}{hour}
                 \PY{n}{day\PYZus{}of\PYZus{}week} \PY{o}{=} \PY{n}{temp}\PY{o}{.}\PY{n}{strftime}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{A}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
             \PY{c+c1}{\PYZsh{}print((month, hour, day\PYZus{}of\PYZus{}week))}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}79}]:} \PY{k}{def} \PY{n+nf}{type\PYZus{}of\PYZus{}user}\PY{p}{(}\PY{n}{datum}\PY{p}{,} \PY{n}{city}\PY{p}{)}\PY{p}{:}
             \PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}}
         \PY{l+s+sd}{    Takes as input a dictionary containing info about a single trip (datum) and}
         ...
         \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
             ...
             \PY{c+c1}{\PYZsh{} YOUR CODE HERE}
             \PY{k}{if} \PY{n}{city} \PY{o}{==} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{NYC}\PY{l+s+s2}{\PYZdq{}}\PY{p}{:}
                 \PY{n}{user\PYZus{}type} \PY{o}{=} \PY{n+nb}{list}\PY{p}{(}\PY{n}{datum}\PY{o}{.}\PY{n}{values}\PY{p}{(}\PY{p}{)}\PY{p}{)}\PY{p}{[}\PY{l+m+mi}{12}\PY{p}{]}
             \PY{k}{elif} \PY{n}{city} \PY{o}{==} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Chicago}\PY{l+s+s2}{\PYZdq{}}\PY{p}{:}
                 \PY{n}{user\PYZus{}type} \PY{o}{=} \PY{n+nb}{list}\PY{p}{(}\PY{n}{datum}\PY{o}{.}\PY{n}{values}\PY{p}{(}\PY{p}{)}\PY{p}{)}\PY{p}{[}\PY{l+m+mi}{9}\PY{p}{]}
             \PY{k}{else}\PY{p}{:}
                 \PY{n}{custype} \PY{o}{=} \PY{n+nb}{list}\PY{p}{(}\PY{n}{datum}\PY{o}{.}\PY{n}{values}\PY{p}{(}\PY{p}{)}\PY{p}{)}\PY{p}{[}\PY{l+m+mi}{8}\PY{p}{]}
                 \PY{k}{if} \PY{n}{custype} \PY{o}{==}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Registered}\PY{l+s+s2}{\PYZdq{}}\PY{p}{:}
...
be consistent with the example file.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}86}]:} \PY{k}{def} \PY{n+nf}{condense\PYZus{}data}\PY{p}{(}\PY{n}{in\PYZus{}file}\PY{p}{,} \PY{n}{out\PYZus{}file}\PY{p}{,} \PY{n}{city}\PY{p}{)}\PY{p}{:}
             \PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}}
         ...
         \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
             ...
             \PY{k}{with} \PY{n+nb}{open}\PY{p}{(}\PY{n}{out\PYZus{}file}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{w}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)} \PY{k}{as} \PY{n}{f\PYZus{}out}\PY{p}{,} \PY{n+nb}{open}\PY{p}{(}\PY{n}{in\PYZus{}file}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{r}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)} \PY{k}{as} \PY{n}{f\PYZus{}in}\PY{p}{:}
                 ...
                 \PY{k}{for} \PY{n}{row} \PY{o+ow}{in} \PY{n}{trip\PYZus{}reader}\PY{p}{:}
                     ...
                     \PY{c+c1}{\PYZsh{}print(time\PYZus{}of\PYZus{}trip(row,city)[0])}
                     ...
                     \PY{n}{temp} \PY{o}{=} \PY{n}{time\PYZus{}of\PYZus{}trip}\PY{p}{(}\PY{n}{row}\PY{p}{,}\PY{n}{city}\PY{p}{)}
                     \PY{n}{new\PYZus{}point}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{month}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{=} \PY{n}{temp}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}
                     \PY{n}{new\PYZus{}point}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{hour}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{=} \PY{n}{temp}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}
                     \PY{n}{new\PYZus{}point}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{day\PYZus{}of\PYZus{}week}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{=} \PY{n}{temp}\PY{p}{[}\PY{l+m+mi}{2}\PY{p}{]}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}87}]:} \PY{c+c1}{\PYZsh{} Run this cell to check your work}
...
\textbf{Answer}: 1. New York City has the highest number of trips. 2.
New York City has the highest proportion of trips made by subscribers.
3. Chicago as the highest proportion of trips made by short-term
customers.

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}88}]:} \PY{k}{def} \PY{n+nf}{number\PYZus{}of\PYZus{}trips}\PY{p}{(}\PY{n}{filename}\PY{p}{)}\PY{p}{:}
             \PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}89}]:} \PY{c+c1}{\PYZsh{}\PYZsh{} Modify this and the previous cell to answer Question 4a. Remember to run \PYZsh{}\PYZsh{}}
...
(5666, 633, 6299)
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}97}]:} \PY{n}{data\PYZus{}file} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./data/Washington\PYZhy{}2016\PYZhy{}Summary.csv}\PY{l+s+s1}{\PYZsq{}}
         \PY{n}{trip\PYZus{}category} \PY{o}{=} \PY{n}{number\PYZus{}of\PYZus{}trips}\PY{p}{(}\PY{n}{data\PYZus{}file}\PY{p}{)}
         \PY{n+nb}{print}\PY{p}{(}\PY{n}{trip\PYZus{}category}\PY{p}{[}\PY{l+m+mi}{2}\PY{p}{]}\PY{p}{)}
         \PY{n+nb}{print}\PY{p}{(}\PY{n}{trip\PYZus{}category}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{o}{/}\PY{n}{trip\PYZus{}category}\PY{p}{[}\PY{l+m+mi}{2}\PY{p}{]}\PY{p}{,}\PY{n}{trip\PYZus{}category}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{o}{/}\PY{n}{trip\PYZus{}category}\PY{p}{[}\PY{l+m+mi}{2}\PY{p}{]}\PY{p}{)}
\end{Verbatim}
...
0.7802822422579381 0.21971775774206193
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}98}]:} \PY{n}{data\PYZus{}file} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./data/Chicago\PYZhy{}2016\PYZhy{}Summary.csv}\PY{l+s+s1}{\PYZsq{}}
         \PY{n}{trip\PYZus{}category} \PY{o}{=} \PY{n}{number\PYZus{}of\PYZus{}trips}\PY{p}{(}\PY{n}{data\PYZus{}file}\PY{p}{)}
         \PY{n+nb}{print}\PY{p}{(}\PY{n}{trip\PYZus{}category}\PY{p}{[}\PY{l+m+mi}{2}\PY{p}{]}\PY{p}{)}
         \PY{n+nb}{print}\PY{p}{(}\PY{n}{trip\PYZus{}category}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{o}{/}\PY{n}{trip\PYZus{}category}\PY{p}{[}\PY{l+m+mi}{2}\PY{p}{]}\PY{p}{,}\PY{n}{trip\PYZus{}category}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{o}{/}\PY{n}{trip\PYZus{}category}\PY{p}{[}\PY{l+m+mi}{2}\PY{p}{]}\PY{p}{)}
\end{Verbatim}
...
0.7622520136973008 0.23774798630269925
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}99}]:} \PY{n}{data\PYZus{}file} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./data/NYC\PYZhy{}2016\PYZhy{}Summary.csv}\PY{l+s+s1}{\PYZsq{}}
         \PY{n}{trip\PYZus{}category} \PY{o}{=} \PY{n}{number\PYZus{}of\PYZus{}trips}\PY{p}{(}\PY{n}{data\PYZus{}file}\PY{p}{)}
         \PY{n+nb}{print}\PY{p}{(}\PY{n}{trip\PYZus{}category}\PY{p}{[}\PY{l+m+mi}{2}\PY{p}{]}\PY{p}{)}
         \PY{n+nb}{print}\PY{p}{(}\PY{n}{trip\PYZus{}category}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{o}{/}\PY{n}{trip\PYZus{}category}\PY{p}{[}\PY{l+m+mi}{2}\PY{p}{]}\PY{p}{,}\PY{n}{trip\PYZus{}category}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{o}{/}\PY{n}{trip\PYZus{}category}\PY{p}{[}\PY{l+m+mi}{2}\PY{p}{]}\PY{p}{)}
\end{Verbatim}
...
\textbf{Answer}: New York City = 15.8.

\begin{enumerate}
\def\labelenumi{\arabic{enumi}.}
\tightlist
\item
  Average trip length (minutes): (1) Washington = 18.9, (2) Chicago =
  16.6, (3) New York City = 15.8.
\item
  Proportion of rides that are longer than 30 minutes: (1) Washington =
  10.8, (2) Chicago = 8.3, (3) New York City = 7.3.
\end{enumerate}

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}107}]:} \PY{c+c1}{\PYZsh{}\PYZsh{} Use this and additional cells to answer Question 4b.                 \PYZsh{}\PYZsh{}}
          ...
          \PY{k}{def} \PY{n+nf}{average\PYZus{}duration}\PY{p}{(}\PY{n}{filename}\PY{p}{)}\PY{p}{:}
              \PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}}
          \PY{l+s+sd}{    This function reads in a file with trip data and reports the overall}
          \PY{l+s+sd}{    average trip duration and proportion of trips longer than 30 minutes.}
          \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
              \PY{k}{with} \PY{n+nb}{open}\PY{p}{(}\PY{n}{filename}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{r}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)} \PY{k}{as} \PY{n}{f\PYZus{}in}\PY{p}{:}
                  \PY{c+c1}{\PYZsh{} set up csv reader object}
                  \PY{n}{reader} \PY{o}{=} \PY{n}{csv}\PY{o}{.}\PY{n}{DictReader}\PY{p}{(}\PY{n}{f\PYZus{}in}\PY{p}{)}
                  ...
                  \PY{c+c1}{\PYZsh{} initialize count variables}
                  \PY{n}{agg}\PY{o}{=}\PY{l+m+mf}{0.0}
                  \PY{n}{count}\PY{o}{=}\PY{l+m+mi}{0}
                  \PY{n}{longer\PYZus{}trip} \PY{o}{=}\PY{l+m+mi}{0}
                  
                  \PY{c+c1}{\PYZsh{} duration aggregator}
                  \PY{k}{for} \PY{n}{row} \PY{o+ow}{in} \PY{n}{reader}\PY{p}{:}
                      \PY{n}{count} \PY{o}{+}\PY{o}{=}\PY{l+m+mi}{1}
                      \PY{n}{agg} \PY{o}{+}\PY{o}{=} \PY{n+nb}{float}\PY{p}{(}\PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{duration}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}
                  ...
                  \PY{c+c1}{\PYZsh{} compute average duration}
                  \PY{n}{avg\PYZus{}duration} \PY{o}{=} \PY{n}{agg}\PY{o}{/}\PY{n+nb}{float}\PY{p}{(}\PY{n}{count}\PY{p}{)}
                  \PY{n}{avg\PYZus{}long\PYZus{}trip} \PY{o}{=} \PY{l+m+mi}{100}\PY{o}{*}\PY{n+nb}{float}\PY{p}{(}\PY{n}{longer\PYZus{}trip}\PY{p}{)}\PY{o}{/}\PY{n+nb}{float}\PY{p}{(}\PY{n}{count}\PY{p}{)}
                  
                  \PY{c+c1}{\PYZsh{} return as a tuple}
                  \PY{k}{return}\PY{p}{(}\PY{n}{avg\PYZus{}duration}\PY{p}{,} \PY{n}{avg\PYZus{}long\PYZus{}trip}\PY{p}{)}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}108}]:} \PY{n}{data\PYZus{}file} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./examples/BayArea\PYZhy{}Y3\PYZhy{}Summary.csv}\PY{l+s+s1}{\PYZsq{}}
          \PY{n+nb}{print}\PY{p}{(}\PY{n}{average\PYZus{}duration}\PY{p}{(}\PY{n}{data\PYZus{}file}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
...
(14.038656929671422, 3.5243689474519764)
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}109}]:} \PY{n}{data\PYZus{}file} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./data/Washington\PYZhy{}2016\PYZhy{}Summary.csv}\PY{l+s+s1}{\PYZsq{}}
          \PY{n+nb}{print}\PY{p}{(}\PY{n}{average\PYZus{}duration}\PY{p}{(}\PY{n}{data\PYZus{}file}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
...
(18.93287355913721, 10.83888671109369)
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}110}]:} \PY{n}{data\PYZus{}file} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./data/Chicago\PYZhy{}2016\PYZhy{}Summary.csv}\PY{l+s+s1}{\PYZsq{}}
          \PY{n+nb}{print}\PY{p}{(}\PY{n}{average\PYZus{}duration}\PY{p}{(}\PY{n}{data\PYZus{}file}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
...
(16.563629368787335, 8.332062497400562)
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}111}]:} \PY{n}{data\PYZus{}file} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./data/NYC\PYZhy{}2016\PYZhy{}Summary.csv}\PY{l+s+s1}{\PYZsq{}}
          \PY{n+nb}{print}\PY{p}{(}\PY{n}{average\PYZus{}duration}\PY{p}{(}\PY{n}{data\PYZus{}file}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
...
\textbf{Answer}: In New York City \textbf{Customers} ride longer, on an
average.

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}117}]:} \PY{c+c1}{\PYZsh{}\PYZsh{} Use this and additional cells to answer Question 4c. If you have    \PYZsh{}\PYZsh{}}
          ...
          \PY{k}{def} \PY{n+nf}{sub\PYZus{}cust\PYZus{}duration}\PY{p}{(}\PY{n}{filename}\PY{p}{)}\PY{p}{:}
              \PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}}
          \PY{l+s+sd}{    This function reads in a file with trip data and reports the overall}
          \PY{l+s+sd}{    average trip duration for subscribers and customers.}
          \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
              \PY{k}{with} \PY{n+nb}{open}\PY{p}{(}\PY{n}{filename}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{r}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)} \PY{k}{as} \PY{n}{f\PYZus{}in}\PY{p}{:}
                  \PY{c+c1}{\PYZsh{} set up csv reader object}
                  \PY{n}{reader} \PY{o}{=} \PY{n}{csv}\PY{o}{.}\PY{n}{DictReader}\PY{p}{(}\PY{n}{f\PYZus{}in}\PY{p}{)}
                  ...
                  \PY{c+c1}{\PYZsh{} initialize count variables}
                  \PY{n}{sub\PYZus{}agg}\PY{o}{=}\PY{l+m+mf}{0.0}
                  \PY{n}{sub\PYZus{}count}\PY{o}{=}\PY{l+m+mi}{0}
                  \PY{n}{cust\PYZus{}agg}\PY{o}{=}\PY{l+m+mf}{0.0}
                  \PY{n}{cust\PYZus{}count}\PY{o}{=}\PY{l+m+mi}{0}
                      
                  \PY{k}{for} \PY{n}{row} \PY{o+ow}{in} \PY{n}{reader}\PY{p}{:}
                      \PY{c+c1}{\PYZsh{}checking for subscriber and customer}
                      \PY{k}{if}\PY{p}{(}\PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{user\PYZus{}type}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Subscriber}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{:}
                          \PY{n}{sub\PYZus{}count} \PY{o}{+}\PY{o}{=}\PY{l+m+mi}{1}
                          \PY{n}{sub\PYZus{}agg} \PY{o}{+}\PY{o}{=} \PY{n+nb}{float}\PY{p}{(}\PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{duration}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}
                      \PY{k}{else}\PY{p}{:}
                          \PY{n}{cust\PYZus{}count} \PY{o}{+}\PY{o}{=}\PY{l+m+mi}{1}
                          \PY{n}{cust\PYZus{}agg} \PY{o}{+}\PY{o}{=} \PY{n+nb}{float}\PY{p}{(}\PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{duration}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}
          
                  
                  
                  \PY{c+c1}{\PYZsh{} compute average duration}
                  \PY{n}{sub\PYZus{}avg} \PY{o}{=} \PY{n+nb}{float}\PY{p}{(}\PY{n}{sub\PYZus{}agg}\PY{p}{)}\PY{o}{/}\PY{n+nb}{float}\PY{p}{(}\PY{n}{sub\PYZus{}count}\PY{p}{)}
                  \PY{n}{cust\PYZus{}avg} \PY{o}{=} \PY{n+nb}{float}\PY{p}{(}\PY{n}{cust\PYZus{}agg}\PY{p}{)}\PY{o}{/}\PY{n+nb}{float}\PY{p}{(}\PY{n}{cust\PYZus{}count}\PY{p}{)}
                  
                  \PY{c+c1}{\PYZsh{} return as a tuple}
                  \PY{k}{return}\PY{p}{(}\PY{n}{sub\PYZus{}avg}\PY{p}{,} \PY{n}{cust\PYZus{}avg}\PY{p}{)}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}113}]:} \PY{n}{data\PYZus{}file} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./examples/BayArea\PYZhy{}Y3\PYZhy{}Summary.csv}\PY{l+s+s1}{\PYZsq{}}
          \PY{n+nb}{print}\PY{p}{(}\PY{n}{sub\PYZus{}cust\PYZus{}duration}\PY{p}{(}\PY{n}{data\PYZus{}file}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
...
(9.512633839275217, 54.55121116377032)
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}114}]:} \PY{n}{data\PYZus{}file} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./data/Washington\PYZhy{}2016\PYZhy{}Summary.csv}\PY{l+s+s1}{\PYZsq{}}
          \PY{n+nb}{print}\PY{p}{(}\PY{n}{sub\PYZus{}cust\PYZus{}duration}\PY{p}{(}\PY{n}{data\PYZus{}file}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
...
(12.528120499294745, 41.67803139252976)
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}115}]:} \PY{n}{data\PYZus{}file} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./data/Chicago\PYZhy{}2016\PYZhy{}Summary.csv}\PY{l+s+s1}{\PYZsq{}}
          \PY{n+nb}{print}\PY{p}{(}\PY{n}{sub\PYZus{}cust\PYZus{}duration}\PY{p}{(}\PY{n}{data\PYZus{}file}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
...
(12.067201690250076, 30.979781133982506)
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}116}]:} \PY{n}{data\PYZus{}file} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./data/NYC\PYZhy{}2016\PYZhy{}Summary.csv}\PY{l+s+s1}{\PYZsq{}}
          \PY{n+nb}{print}\PY{p}{(}\PY{n}{sub\PYZus{}cust\PYZus{}duration}\PY{p}{(}\PY{n}{data\PYZus{}file}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
...
library and to generate an example plot.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}118}]:} \PY{c+c1}{\PYZsh{} load library}
...
and Customers for now: just collect all of the trip times and plot them.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}120}]:} \PY{c+c1}{\PYZsh{} load library}
          \PY{k+kn}{import} \PY{n+nn}{matplotlib}\PY{n+nn}{.}\PY{n+nn}{pyplot} \PY{k}{as} \PY{n+nn}{plt}
          ...
          \PY{c+c1}{\PYZsh{}\PYZsh{} Use this and additional cells to collect all of the trip times as a list \PYZsh{}\PYZsh{}}
          ...
          \PY{k}{def} \PY{n+nf}{trip\PYZus{}times}\PY{p}{(}\PY{n}{filename}\PY{p}{)}\PY{p}{:}
              \PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}}
          \PY{l+s+sd}{    This function reads in a file with trip data and reports a list}
          \PY{l+s+sd}{    of all Trip times}
          \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
              \PY{k}{with} \PY{n+nb}{open}\PY{p}{(}\PY{n}{filename}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{r}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)} \PY{k}{as} \PY{n}{f\PYZus{}in}\PY{p}{:}
                  \PY{c+c1}{\PYZsh{} set up csv reader object}
                  \PY{n}{reader} \PY{o}{=} \PY{n}{csv}\PY{o}{.}\PY{n}{DictReader}\PY{p}{(}\PY{n}{f\PYZus{}in}\PY{p}{)}
                  ...
                  \PY{c+c1}{\PYZsh{} duration aggregator}
                  \PY{k}{for} \PY{n}{row} \PY{o+ow}{in} \PY{n}{reader}\PY{p}{:}
                      \PY{n}{l}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n+nb}{float}\PY{p}{(}\PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{duration}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}\PY{p}{)}
                  
                  \PY{c+c1}{\PYZsh{} return as a tuple}
                  \PY{k}{return}\PY{p}{(}\PY{n}{l}\PY{p}{)}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}122}]:} \PY{n}{data\PYZus{}file} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./data/NYC\PYZhy{}2016\PYZhy{}Summary.csv}\PY{l+s+s1}{\PYZsq{}}
          \PY{n}{data} \PY{o}{=} \PY{n}{trip\PYZus{}times}\PY{p}{(}\PY{n}{data\PYZus{}file}\PY{p}{)}
          \PY{n}{plt}\PY{o}{.}\PY{n}{hist}\PY{p}{(}\PY{n}{data}\PY{p}{,}\PY{n+nb}{range}\PY{o}{=}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,}\PY{l+m+mi}{75}\PY{p}{)}\PY{p}{)}
          \PY{n}{plt}\PY{o}{.}\PY{n}{title}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Distribution of Trip Durations}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
          \PY{n}{plt}\PY{o}{.}\PY{n}{xlabel}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Duration (m)}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
          \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}
\end{Verbatim}
...
\textbf{Answer}: For New York City: 1. Subscriber: Peak is for 5-10
minutes duration. Shape is right skewed distribution, with people being
much more in lower durations. 2. Customer: Peak is for 20-25 minutes
duration. Shape is lesser right skewed distribution, with people are
distributed more evenly.

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}123}]:} \PY{c+c1}{\PYZsh{}\PYZsh{} Use this and additional cells to answer Question 5. \PYZsh{}\PYZsh{}}
          \PY{k}{def} \PY{n+nf}{sub\PYZus{}cust\PYZus{}trip\PYZus{}list}\PY{p}{(}\PY{n}{filename}\PY{p}{)}\PY{p}{:}
              \PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}}
          \PY{l+s+sd}{    This function reads in a file with trip data and reports list}
          \PY{l+s+sd}{    of duration for customer and subscriber.}
          \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
              \PY{k}{with} \PY{n+nb}{open}\PY{p}{(}\PY{n}{filename}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{r}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)} \PY{k}{as} \PY{n}{f\PYZus{}in}\PY{p}{:}
                  \PY{c+c1}{\PYZsh{} set up csv reader object}
                  \PY{n}{reader} \PY{o}{=} \PY{n}{csv}\PY{o}{.}\PY{n}{DictReader}\PY{p}{(}\PY{n}{f\PYZus{}in}\PY{p}{)}
                  ...
                  \PY{k}{for} \PY{n}{row} \PY{o+ow}{in} \PY{n}{reader}\PY{p}{:}
                      \PY{c+c1}{\PYZsh{}checking for subscriber and customer}
                      \PY{k}{if}\PY{p}{(}\PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{user\PYZus{}type}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Subscriber}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{:}
                          \PY{n}{sub}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n+nb}{float}\PY{p}{(}\PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{duration}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}\PY{p}{)}
                      \PY{k}{else}\PY{p}{:}
                  ...
                  \PY{c+c1}{\PYZsh{} return as a tuple}
                  \PY{k}{return}\PY{p}{(}\PY{n}{sub}\PY{p}{,} \PY{n}{cust}\PY{p}{)}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}150}]:} \PY{n}{data\PYZus{}file} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./data/NYC\PYZhy{}2016\PYZhy{}Summary.csv}\PY{l+s+s1}{\PYZsq{}}
          \PY{n}{data} \PY{o}{=} \PY{n}{sub\PYZus{}cust\PYZus{}trip\PYZus{}list}\PY{p}{(}\PY{n}{data\PYZus{}file}\PY{p}{)}
          \PY{n}{data\PYZus{}sub} \PY{o}{=} \PY{n}{data}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}
          \PY{n}{data\PYZus{}cust} \PY{o}{=} \PY{n}{data}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}
          \PY{n}{plt}\PY{o}{.}\PY{n}{hist}\PY{p}{(}\PY{n}{data\PYZus{}sub}\PY{p}{,}\PY{n+nb}{range}\PY{o}{=}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,}\PY{l+m+mi}{75}\PY{p}{)}\PY{p}{,}\PY{n}{bins}\PY{o}{=}\PY{l+m+mi}{15}\PY{p}{,}\PY{n}{edgecolor}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{black}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{n}{linewidth}\PY{o}{=}\PY{l+m+mf}{1.2}\PY{p}{)}
          \PY{n}{plt}\PY{o}{.}\PY{n}{title}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Subscriber : Distribution of Trip Durations}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
          \PY{n}{plt}\PY{o}{.}\PY{n}{xlabel}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Duration (m)}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
          \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}
          \PY{n}{plt}\PY{o}{.}\PY{n}{hist}\PY{p}{(}\PY{n}{data\PYZus{}cust}\PY{p}{,}\PY{n+nb}{range}\PY{o}{=}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,}\PY{l+m+mi}{75}\PY{p}{)}\PY{p}{,}\PY{n}{bins}\PY{o}{=}\PY{l+m+mi}{15}\PY{p}{,}\PY{n}{edgecolor}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{black}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{n}{linewidth}\PY{o}{=}\PY{l+m+mf}{1.2}\PY{p}{)}
          \PY{n}{plt}\PY{o}{.}\PY{n}{title}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Customer : Distribution of Trip Durations}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
          \PY{n}{plt}\PY{o}{.}\PY{n}{xlabel}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Duration (m)}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
          \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}
\end{Verbatim}
...
\textbf{Answer}: The question I am trying to address is: "How does
ridership differ by month in all three cities? Which month has the
highest ridership? Does the ratio of Customer to Subscriber trips change
depending on the month or season"

\begin{enumerate}
\def\labelenumi{\arabic{enumi}.}
\item
  In NYC and Washington, surprisingly the subscriber ridership increases
  in December, whereas for Chicago the ridership by subscribers is
  highest in the summer months May-July. For the ridership by Customers,
  the highest usage is in July for Chicago and Washinton. In NYC,
  Customers have highest demand in August and September.
\item
  Interestingly, we find that the proportion of customer significantly
  increases in the summer months with the highest being in July and
  lowest in the winter months, for all three cities.
\end{enumerate}

An interesting extension of this project will be observing everyday
ridership with temperature.

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}214}]:} \PY{c+c1}{\PYZsh{}\PYZsh{} Use this and additional cells to continue to explore the dataset. \PYZsh{}\PYZsh{}}
          ...
          \PY{k}{def} \PY{n+nf}{sub\PYZus{}cust\PYZus{}month\PYZus{}list}\PY{p}{(}\PY{n}{filename}\PY{p}{)}\PY{p}{:}
              \PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}}
          \PY{l+s+sd}{    This function reads in a file with trip data and reports list}
          \PY{l+s+sd}{    of months used for both customer and subscriber.}
          \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
              \PY{k}{with} \PY{n+nb}{open}\PY{p}{(}\PY{n}{filename}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{r}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)} \PY{k}{as} \PY{n}{f\PYZus{}in}\PY{p}{:}
                  \PY{c+c1}{\PYZsh{} set up csv reader object}
                  \PY{n}{reader} \PY{o}{=} \PY{n}{csv}\PY{o}{.}\PY{n}{DictReader}\PY{p}{(}\PY{n}{f\PYZus{}in}\PY{p}{)}
                  ...
                  \PY{k}{for} \PY{n}{row} \PY{o+ow}{in} \PY{n}{reader}\PY{p}{:}
                      \PY{c+c1}{\PYZsh{}checking for subscriber and customer}
                      \PY{k}{if}\PY{p}{(}\PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{user\PYZus{}type}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Subscriber}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{:}
                          \PY{n}{sub}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n+nb}{float}\PY{p}{(}\PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{month}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}\PY{p}{)}
                      \PY{k}{else}\PY{p}{:}
                          \PY{n}{cust}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n+nb}{float}\PY{p}{(}\PY{n}{row}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{month}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}\PY{p}{)}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}213}]:} \PY{c+c1}{\PYZsh{} list of files for each city}
          ...
          \PY{c+c1}{\PYZsh{} Creating a canvas for plotting}
          \PY{n}{fig} \PY{o}{=} \PY{n}{plt}\PY{o}{.}\PY{n}{figure}\PY{p}{(}\PY{n}{figsize}\PY{o}{=}\PY{p}{(}\PY{l+m+mi}{14}\PY{p}{,} \PY{l+m+mi}{10}\PY{p}{)}\PY{p}{)}
          \PY{n}{fig}\PY{o}{.}\PY{n}{text}\PY{p}{(}\PY{l+m+mf}{0.5}\PY{p}{,} \PY{l+m+mf}{0.04}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Months}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{ha}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{center}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{size}\PY{o}{=} \PY{l+m+mi}{20}\PY{p}{)}
          \PY{n}{fig}\PY{o}{.}\PY{n}{text}\PY{p}{(}\PY{l+m+mf}{0.06}\PY{p}{,} \PY{l+m+mf}{0.77}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Subscriber Total Trips}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{va}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{center}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{rotation}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{vertical}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{size}\PY{o}{=} \PY{l+m+mi}{14}\PY{p}{)}
          \PY{n}{fig}\PY{o}{.}\PY{n}{text}\PY{p}{(}\PY{l+m+mf}{0.06}\PY{p}{,} \PY{l+m+mf}{0.50}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Customer Total Trips}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{va}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{center}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{rotation}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{vertical}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{size}\PY{o}{=} \PY{l+m+mi}{14}\PY{p}{)}
          \PY{n}{fig}\PY{o}{.}\PY{n}{text}\PY{p}{(}\PY{l+m+mf}{0.06}\PY{p}{,} \PY{l+m+mf}{0.24}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Customer:Subscriber}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{va}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{center}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{rotation}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{vertical}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{size}\PY{o}{=} \PY{l+m+mi}{14}\PY{p}{)}
          
          \PY{k}{for} \PY{n}{data\PYZus{}file} \PY{o+ow}{in} \PY{n}{data\PYZus{}files}\PY{p}{:}
              
              \PY{n}{city} \PY{o}{=} \PY{n}{data\PYZus{}file}\PY{o}{.}\PY{n}{split}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZhy{}}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{o}{.}\PY{n}{split}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{/}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{[}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{]} \PY{c+c1}{\PYZsh{} city name}
              
              \PY{n}{data} \PY{o}{=} \PY{n}{sub\PYZus{}cust\PYZus{}month\PYZus{}list}\PY{p}{(}\PY{n}{data\PYZus{}file}\PY{p}{)}
              \PY{n}{data\PYZus{}sub} \PY{o}{=} \PY{n}{data}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}
              \PY{n}{data\PYZus{}cust} \PY{o}{=} \PY{n}{data}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}
              
              \PY{c+c1}{\PYZsh{}total number of subscriber in a month}
              \PY{n}{sub1} \PY{o}{=} \PY{n}{fig}\PY{o}{.}\PY{n}{add\PYZus{}subplot}\PY{p}{(}\PY{l+m+mi}{3}\PY{p}{,}\PY{l+m+mi}{3}\PY{p}{,}\PY{l+m+mi}{1}\PY{o}{+}\PY{n}{count}\PY{p}{)}
              \PY{n}{sub1}\PY{o}{.}\PY{n}{hist}\PY{p}{(}\PY{n}{data\PYZus{}sub}\PY{p}{,}\PY{n}{edgecolor}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{black}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{n}{linewidth}\PY{o}{=}\PY{l+m+mf}{1.2}\PY{p}{)}
              \PY{n}{sub1}\PY{o}{.}\PY{n}{set\PYZus{}title}\PY{p}{(}\PY{n}{city}\PY{p}{,}\PY{n}{size}\PY{o}{=} \PY{l+m+mi}{20}\PY{p}{)}
              
              \PY{c+c1}{\PYZsh{}total number of customers in a month}
              \PY{n}{sub2} \PY{o}{=} \PY{n}{fig}\PY{o}{.}\PY{n}{add\PYZus{}subplot}\PY{p}{(}\PY{l+m+mi}{3}\PY{p}{,}\PY{l+m+mi}{3}\PY{p}{,}\PY{l+m+mi}{4}\PY{o}{+}\PY{n}{count}\PY{p}{)}
              \PY{n}{sub2}\PY{o}{.}\PY{n}{hist}\PY{p}{(}\PY{n}{data\PYZus{}cust}\PY{p}{,} \PY{n}{color}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{orange}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,}\PY{n}{edgecolor}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{black}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{n}{linewidth}\PY{o}{=}\PY{l+m+mf}{1.2}\PY{p}{)}
              
              \PY{c+c1}{\PYZsh{}Finding proportion of Customer to Subscriber monthwise}
              \PY{n}{s} \PY{o}{=} \PY{n}{Counter}\PY{p}{(}\PY{n}{data\PYZus{}sub}\PY{p}{)}
              \PY{n}{c} \PY{o}{=} \PY{n}{Counter}\PY{p}{(}\PY{n}{data\PYZus{}cust}\PY{p}{)}
              \PY{n}{proportion} \PY{o}{=}\PY{p}{\PYZob{}}\PY{p}{\PYZcb{}}
              \PY{k}{for} \PY{n}{n\PYZus{}month} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{13}\PY{p}{)}\PY{p}{:}
                  \PY{n}{proportion}\PY{p}{[}\PY{n+nb}{float}\PY{p}{(}\PY{n}{n\PYZus{}month}\PY{p}{)}\PY{p}{]}\PY{o}{=}\PY{n+nb}{float}\PY{p}{(}\PY{n}{c}\PY{p}{[}\PY{n+nb}{float}\PY{p}{(}\PY{n}{n\PYZus{}month}\PY{p}{)}\PY{p}{]}\PY{p}{)}\PY{o}{/}\PY{n+nb}{float}\PY{p}{(}\PY{n}{s}\PY{p}{[}\PY{n+nb}{float}\PY{p}{(}\PY{n}{n\PYZus{}month}\PY{p}{)}\PY{p}{]}\PY{p}{)}
                  
              \PY{n}{lists} \PY{o}{=} \PY{n+nb}{sorted}\PY{p}{(}\PY{n}{proportion}\PY{o}{.}\PY{n}{items}\PY{p}{(}\PY{p}{)}\PY{p}{)} \PY{c+c1}{\PYZsh{} sorted by key, return a list of tuples}
              \PY{n}{x}\PY{p}{,} \PY{n}{y} \PY{o}{=} \PY{n+nb}{zip}\PY{p}{(}\PY{o}{*}\PY{n}{lists}\PY{p}{)} \PY{c+c1}{\PYZsh{} unpack a list of pairs into two tuples}
              
              \PY{n}{sub3} \PY{o}{=} \PY{n}{fig}\PY{o}{.}\PY{n}{add\PYZus{}subplot}\PY{p}{(}\PY{l+m+mi}{3}\PY{p}{,}\PY{l+m+mi}{3}\PY{p}{,}\PY{l+m+mi}{7}\PY{o}{+}\PY{n}{count}\PY{p}{)}
              \PY{n}{sub3}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{n}{x}\PY{p}{,} \PY{n}{y}\PY{p}{,}\PY{n}{marker}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{o}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{n}{linestyle}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZhy{}}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{n}{color}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{r}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
              
              \PY{n}{count}\PY{o}{+}\PY{o}{=}\PY{l+m+mi}{1} \PY{c+c1}{\PYZsh{} for looping over the three cities}
\end{Verbatim}
...
\textbf{Answer}: Another interesting topic can be using the "Consumer
Complaint Database"
(https://www.consumerfinance.gov/data-research/consumer-complaints/) to
get an outsider perspective of some of the financial products such as
Credit Cards or Mortgage. A possible scenario is say if you are in the
market for getting a mortgage then you can actually see if, say for Bank
of America, how does the complaints for it changed over the years. I
think this analysis can provide a performance aggregated factor that is
